<?php
include("sui.php");
$pagename="Modern Ethnic wear for Women & Men"; //Create and populate a variable called $pagename
echo "<link rel=stylesheet type=text/css href=styleprod.css>"; //Call in stylesheet
